...
namespace SaleWebApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(SaleManagementContext context)
        {
            _context = context;
        }
        ...
        {
            var saleManagementContext = _context.Products.Include(p => p.Category);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SaleManagementContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
